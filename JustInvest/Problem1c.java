...
public class Problem1c {
    ...
    static {
        ...
        permissions.put("PC", new String[]{"1.View Account Balance", "2.View Investment Portfolio", "3.Modify Investment Portfolio", "5.View Financial Planner Contact info"});
        ...
        permissions.put("FP", new String[]{"1.View Account Balance", "2.View Investment Portfolio", "6.View Money Market Instruments"});
    ...
    public static void checkOperations(String Role, String operation) {
        ...
        } else if (Role.equals("PC") && (operation.equals("1") || operation.equals("2") || operation.equals("3") || operation.equals("5"))) {
            System.out.println("Operation Successful!");
        } else if (Role.equals("FA") && (operation.equals("1") || operation.equals("2") || operation.equals("3") || operation.equals("7"))) {
            System.out.println("Operation Successful!");
        } else if (Role.equals("FP") && (operation.equals("1") || operation.equals("2") || operation.equals("6") )) {
            System.out.println("Operation Successful!");
